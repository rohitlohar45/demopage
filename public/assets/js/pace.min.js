...
!function () {
				...
				for (
					...
					if ((e = s[o]))
						for (t in e)
							K.call(e, t) &&
								((n = e[t]),
								null != r[t] && "object" == typeof r[t] && null != n && "object" == typeof n
									? d(r[t], n)
									: (r[t] = n));
				return r;
			},
	...
	function et() {
		...
		et.__super__.constructor.apply(this, arguments),
			(e = function (r) {
				...
				return (r.open = function (t, e, n) {
					return (
						A(t) && o.trigger("request", { type: t, url: e, request: r }), s.apply(r, arguments)
					);
				});
			}),
		...
		if (null != F && T.ajax.trackWebSockets) {
			window.WebSocket = function (t, e) {
				...
				return (
					A("socket") && o.trigger("request", { type: "socket", url: t, protocols: e, request: n }),
					n
				);
			};
			try {
	...
	(B = Error),
		...
		(x = function () {
			var t, e, n, r, s, o, i, a;
			for (
				y.sources = N = [], e = 0, r = (o = ["ajax", "elements", "document", "eventLag"]).length;
				e < r;
				e++
			)
		...
		(y.go = function () {
			...
			return (
				...
				(e = O(function (t, e) {
					w.progress;
					for (
						var n, r, s, o, i, a, u, c, l, p, h = (a = 0), f = !0, g = (u = 0), d = N.length;
						u < d;
						g = ++u
					)
						for (
