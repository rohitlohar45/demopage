const beforeAndAfterSlider = () => {
	...
	if (slider) {
		...
		const beforeText = document.querySelector("#before-after-slider .twentytwenty-before-label");
		const afterText = document.querySelector("#before-after-slider .twentytwenty-after-label");

		let active = false;

		let width = slider.offsetWidth;
		// check if beforeImage exists
