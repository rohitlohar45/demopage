          ...
          <form id="contact-form" onSubmit={handleSubmit}>
            <div className="text-center" style={{ marginBottom: "10px" }}>
              ...
              <p className="text-center" style={{ marginBottom: "10px" }}>
                ...
                If you are passionate about design and architecture, we would
                love to hear from you. Please fill out the form below and attach
                your <b> Resume/CV </b>.
              </p>
            </div>
            ...
            <div className="controls">
              ...
              <div className="form-group">
                ...
                {formErrors.applyFor && (
                  <p className="text-danger">{formErrors.applyFor}</p>
                )}
              </div>
