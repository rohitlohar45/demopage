	...
	return (
		<section className="after-before section-padding">
			...
			<div className="container ontop">
				<div className="section-head text-center wow fadeInUp" data-wow-delay=".3s">
					...
					<div className="col-lg-12">
						<div className="dotsbg wow fadeInUp" data-wow-delay=".3s">
							<div id="before-after-slider" className="wow imago">
								...
								<div className="twentytwenty-before-label" data-content="Without Light"></div>
								<div className="twentytwenty-after-label" data-content="With Light  "></div>
								<div id="before-image">{beforeImage && <img src={beforeImage} alt="before" />}</div>
								<div id="after-image">
