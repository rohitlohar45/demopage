					...
					<div className="col-lg-3 col-md-6 coulmn wow fadeInUp" data-wow-delay=".3s">
						<div className="item">
							...
							<div className="cont">
								...
								<p>We have a culture of high performance that is based on employee engagement.</p>
							</div>
						</div>
					</div>
					<div className="col-lg-3 col-md-6 coulmn wow fadeInUp" data-wow-delay=".5s">
						<div className="item">
							...
							<div className="cont">
								...
								<p>
									Diversity at Peace Interiors is about celebrating individuality, creativity &
									innovation.
								</p>
							</div>
						</div>
					...
					<div className="col-lg-3 col-md-6 coulmn wow fadeInUp" data-wow-delay=".4s">
						<div className="item">
							...
							<div className="cont">
								...
								<p>We are committed to doing business in a responsible & sustainable way.</p>
							</div>
						</div>
					</div>
					<div className="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay=".6s">
						<div className="item">
							...
							<div className="cont">
								...
								<p>
									Our culture expresses how we interact with each other to achieve our business
									objectives.
								</p>
							</div>
						</div>
