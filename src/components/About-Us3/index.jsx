				...
				<div className="row">
					<div className="col-lg-5">
						<div className="extra wow fadeInUp" data-wow-delay=".3s">
							...
							<p>
								Architecture bibendum pharetra eleifend. Suspendisse vel volutpat purus, sit amet
								bibendum nisl. mollis turpis a ipsum ultes, nec condi mentum ipsum consequat. Mauris
			...
			>
				...
				>
					<svg className="circle-fill">
						<circle cx="43" cy="43" r="39" stroke="#ffee32" strokeWidth=".5"></circle>
					</svg>
